...
This file exists only for a released consumer that hardcodes the old path. A consumer that cannot resolve the new manifest-selected technique must fail closed and must not treat this redirect as an integration authority.
