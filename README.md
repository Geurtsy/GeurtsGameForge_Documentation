...
The compact forge icon has a clean silhouette without a decorative outline, designed for small viewing. It puffs smoke and bounces gently during active work, then rests when work ends. Stage and result text stay to its left in the pinned strip; the animation is an activity indicator rather than a completion percentage.
