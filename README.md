...
God 0.5.0 and standalone Diagnostics are governed by the [Diagnostics Technique](GeurtsTechniques/GeurtsDiagnosticsTechnique.md). Diagnostics 0.4.0 is a review candidate adding the resizable performance overlay; the catalogue continues to identify the merged 0.3.0 release until an exact 0.4.0 revision is approved and published. Diagnostics requires God 0.5.0; install or update God before Diagnostics.
