...
Catalogue entries start expanded and collapse independently when you click their heading or arrow. Collapsed cards keep the package name, installation/lifecycle state and update status visible; expand a card to view its details and package actions. Each window retains its collapsed choices through searches, filters, catalogue refreshes and script reloads.
