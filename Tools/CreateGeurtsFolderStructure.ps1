...
try {
    ...
    if ([string]$definition.definitionVersion -ne "0.11.0" -or [string]$definition.packageVersion -ne "0.22.5") {
        throw "Folder definition version must be 0.11.0 and package version must be 0.22.5."
    }
