...
try {
    ...
    if ([string]$definition.definitionVersion -ne "0.11.0" -or [string]$definition.packageVersion -ne "0.18.0") {
        throw "Folder definition version must be 0.11.0 and package version must be 0.18.0."
    }
