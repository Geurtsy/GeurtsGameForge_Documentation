...
try {
    ...
    foreach ($requiredThemeRule in @(
        ...
        'Geurts.GameForge.God.Editor', 'ForgeEditorTheme.Scope()', 'ForgeEditorTheme.ApplyToolkit(root)',
        'must remain usable without God and must not gain a God, Odin Inspector or Quantum Console dependency for styling',
