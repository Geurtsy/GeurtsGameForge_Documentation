...
**Version:** 0.11.0
**Status:** Non-normative historical product pointer
**Required package path:** `Ideas/GameForgeIntelligenceIdeas.md`
...
`Migrations/v0.11.0.md` is non-normative transition guidance, not part of accepted package behaviour. Older migration notes are superseded history.
...
The former selective-copy, stateful launch-check/download, transaction/recovery, competing generated-policy, ambiguous entry-route, and product-owned documentation workflow ideas are superseded. The active companion may perform only a metadata-only Unity-open check before its explicit confirmed Update. Retain this concise pointer only to explain provenance; do not use it to override the active package.
